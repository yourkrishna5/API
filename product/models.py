...
class Product(models.Model):
    ...
    image_url = models.URLField(blank=True, null=True)  # Changed from ImageField
...
class Info(models.Model):
    ...
    profile_picture_url = models.URLField(blank=True, null=True)  # Changed from ImageField
